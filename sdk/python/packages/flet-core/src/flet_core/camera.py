...
class Camera(ConstrainedControl):
    ...
    async def start_video_recording_async(self):
        await self.page.invoke_method_async("start_video_recording", control_id=self.uid)

    def stop_video_recording(self):
        self.page.invoke_method("stop_video_recording", control_id=self.uid)

    async def stop_video_recording(self):
        await self.page.invoke_method_async("stop_video_recording", control_id=self.uid)
